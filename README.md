...
| 🟫 **下界合金熔炉** | Netherite Block | 5t/item | 极速熔炼（40倍！）|
...
| 升级 | 效果 | 负面效果 | 槽位 |
|------|------|---------|------|
| ⚡ **速度升级** | 烧炼时间减半 | 燃料消耗 +50% | 🟢 绿色槽 |
| ⛽ **燃料升级** | 燃料效率 ×2 | 烧炼时间 +25% | 🟢 绿色槽 |
| 🏭 **高炉升级** | 可烧制矿石/矿物 | 燃料消耗 ×2 | 🔴 红色槽 |
| 🚬 **烟熏炉升级** | 可烹饪食物 | 燃料消耗 ×2 | 🔴 红色槽 |
| 🏗️ **工业升级** | 输出槽位增加至3个 | 使用能量模式 | 🔵 蓝色槽 |
| ⚙️ **发电机升级** | 将燃料热量转为能量 | 停止烧炼 | 🔵 蓝色槽 |
...
- 重构熔炉 tick 热路径，减少重复配方扫描、对象创建和展示实体查询
- 修复重启后库存监听器与物流组未恢复的问题
- 燃料、发电量和彩虹外观状态现在会随方块持久化
- 修复工业升级切换时输出库存丢失，以及输出物流方向错误的问题
- 增加升级组合和语言资源自动测试
